...
export default function LandingFooter() {
  ...
  const footerLinks = {
    ...
    features: [
      ...
      { label: "Badges", href: "/community/badges" },
      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2">
            ...
            <div className="flex items-center gap-3">
              <a
                href="#"
                className="h-9 w-9 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-slate-700 hover:text-white transition"
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-500">
            &copy; {currentYear} Pulse. Made with love in Denver.
          </p>
